...
### Next tasks
- Browser verification of course assignments (admin assign flow, learner dashboard badge/deadline, `/learn` access without enrollment)
